...
response = {
    ...
    "affirm":["cool","I know you would like it", "OK"],
    "day_preference":["which day?"],
    "time_preference":["Do you have any time preference"],
    "events_link":['You can see more information here <a href="https://webster.bfm.com/myblk/home">BlackRock</a>'],
    "no_events":["No events found"],
    "intro":["I am event bot for finding stock ideas"]
}
import datetime
mapping = {
